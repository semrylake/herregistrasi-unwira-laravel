...
<div class="card mt-3 border shadow">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold">Form Tambah Fakultas</h6>
    </div>
    <form class="form-horizontal" action="/storeFakultas" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="form-group">
                <label for="kode_fakultas" class="control-label col-form-label">Kode Fakultas<sup
                        class="text-danger">*</sup></label>
                <input autofocus type="text" name="kode_fakultas" value="{{ old('kode_fakultas') }}"
