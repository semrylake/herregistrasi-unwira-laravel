...
<div class="card mt-3 border shadow">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold">Form Tambah Loket BAAK</h6>
    </div>
    <form class="form-horizontal" action="/storeLoket" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="form-group">
                <label for="no_loket" class="control-label col-form-label">Nomor Loket<sup
                        class="text-danger">*</sup></label>
                <input type="number" min="1" name="no_loket" value="{{ old('no_loket') }}"
            ...
            <div class="form-group">
                ...
                <div class="form-label-group">
                    <select autofocus class=" form-control @error('user_id') is-invalid @enderror" required
                        ...
                        <option id="user_id" value="{{$a->nip}}" {{ old('user_id')==$a->nip ? 'selected' : null}}
                            class="form-control">
                            {{$a->name}}</option>
                        @empty
            ...
            <div class="form-group">
                <label for="tlpn" class="control-label col-form-label">Nomor Telepon<sup
                        class="text-danger">*</sup></label>
                <input type="text" name="tlpn" value="{{ old('tlpn') }}"
