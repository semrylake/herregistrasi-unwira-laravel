...
<div class="col-md-12">
    ...
    <a href="/tambah-pegawai" class="btn btn-primary mb-2 ">
        <i class="fas fa-plus"></i> Pegawai Baru
    </a>
    @if (session('del_msg'))
    ...
    <div class="main-card mb-3 card p-1">
        <div class="card-header ml-2">Data Pegawai</div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="/edit-pegawai/{{ $a->nip }}" title="Edit" class="btn btn-success btn-sm m-1">
                                    <i class="fas fa-pencil-alt"></i>
                                </a>
                                <form action="/delete-pegawai/{{ $a->nip }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
