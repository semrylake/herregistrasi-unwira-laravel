...
<a href="/pegawai-loket" class="btn btn-info shadow"><i class="fas fa-arrow-left"></i> Kembali</a>

<div class="card mt-3 mb-3 border shadow">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold">Form Edit Pegawai</h6>
    </div>
    <form class="form-horizontal" action="/updatePegawai/{{ $pegawai->nip }}" method="post"
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input autofocus type="text" name="name" value="{{ old('name', $pegawai->name) }}"
            ...
            <div class="form-group">
                ...
                <input autofocus type="text" name="nip" value="{{ old('nip', $pegawai->nip) }}"
            ...
            <div class="form-group">
                ...
                <div class="form-label-group">
                    <select class=" form-control @error('jk') is-invalid @enderror" name="jk" id="jk">
                        ...
                        @if (old('jk', $pegawai->jk) == 'Laki-laki')
                        <option id="jk" value="{{$pegawai->jk}}" selected class="form-control">
                            Laki-laki
                        </option>
                        ...
                        @endif
                        @if (old('jk', $pegawai->jk) == 'Perempuan')
                        <option id="jk" value="{{$pegawai->jk}}" selected class="form-control">
                            Perempuan
                        </option>
