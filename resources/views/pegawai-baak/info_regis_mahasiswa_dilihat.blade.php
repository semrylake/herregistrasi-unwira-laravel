...
<a href="/herregistrasi-sudah-diinput" class="btn btn-info shadow mb-2"><i class="fas fa-arrow-left"></i> Kembali</a>
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <p class="list-group-item">Program Studi : {{ $prodi->name }}</p>
    ...
    <div class="col-md-8">
        <div class="main-card mb-3 card">
            ...
            <div class="ratio ratio-16x9">
                <iframe width="100%" height="480" allow="" type="application/pdf" allowfullscreen
