...
<body>
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
        @include('components.navbar.navbar_admin')
        @include('components.other.dashboard_admin_app_settings')

        <div class="app-main">
            @include('components.sidebar.sidebar_dashboard_admin')
    ...
    <script>
        const nama = document.querySelector('#no');
        const slug = document.querySelector('#slug');
        nama.addEventListener('change', function(){
            fetch('/createSlugPengumuman?nama='+nama.value)
    ...
    <script>
        ...
        $('#tabel_prodi_layanan_loket').DataTable();
